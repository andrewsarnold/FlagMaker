...
{
	public class OverlayPentagram : PathOverlay
	{
		...
		public OverlayPentagram(int maximum)
			: base("pentagram", Path, PathSize, maximum)
		{
		}

		public OverlayPentagram(Color color, int maximum)
			: base(color, "pentagram", Path, PathSize, maximum)
		{
		}
	}
}
